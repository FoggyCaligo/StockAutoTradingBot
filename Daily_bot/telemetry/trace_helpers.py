...
def record_scan_candidate(recorder: Recorder, candidate: Candidate, snapshot: Any, reason: str = "scan_candidate") -> None:
    recorder.save_market_trace(candidate, snapshot, phase="scan_candidate", selected=False, reason=reason)
...
def record_account_snapshot(
    ...
    if open_orders is None:
        try:
            ...
            open_orders = []
    recorder.save_account_trace(phase, cash, account_value or 0, positions, open_orders)
